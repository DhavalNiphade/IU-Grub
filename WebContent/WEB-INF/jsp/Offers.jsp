            ...
            <div class="panel panel-default">
              ...
              <!--   <div class="panel-body">Indian
               ...
               <div class="panel-body">Lebanese
				...
				<label class="custom-control custom-checkbox pull-right">
                        <input type="checkbox" class="custom-control-input campusSelection" onclick="javascript:campusSelect(this);" id="Indiana Memorial Union">
                        <span class="custom-control-indicator"></span>
                </label>
                </div>
                <div class="panel-body">Wells Library
				<label class="custom-control custom-checkbox pull-right">
                        <input type="checkbox" class="custom-control-input campusSelection" id="Wells Library" onclick="javascript:campusSelect(this);">
                        <span class="custom-control-indicator"></span>
                </label>
                </div>
                <div class="panel-body">Downtown
				<label class="custom-control custom-checkbox pull-right">
                        <input type="checkbox" class="custom-control-input campusSelection" id="Downtown" onclick="javascript:campusSelect(this);">
                        <span class="custom-control-indicator"></span>
                </label>
                </div>
                </div>
...
<script type="text/javascript">
    ...
    function campusSelect(object) {
    	...
    	updateStoreFilters(campusArray);
    }
    ...
    function updateStoreFilters(campusArray) {
    	...
    	if(campusArray.length==0) {
    		...
    		searchOffers(blankArray,campusArray);
	    	jQuery.ajax({
	        		
	        	    url : "/IUGRUB/filters/updateStoreFilters",
	        	    type: "POST",
	        	    data : {CAMPUS_SELECTION:campusArray},
	        	    success: function(data, textStatus, jqXHR)
	        	    {
	        	        //data - response from server
	        	    	   jQuery("#foodStoreSelection").html(data);
