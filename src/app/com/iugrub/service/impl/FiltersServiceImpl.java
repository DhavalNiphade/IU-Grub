...
public class FiltersServiceImpl implements FiltersServiceAPI {
	...
	@Override
	public List<Offers> getOffersForSelectedFoodStores(List<String> listStoreFilters) {
		// TODO Auto-generated method stub
		List<Offers> listOfOffers = new ArrayList<Offers>();
		if(listStoreFilters.isEmpty()) {
			listOfOffers = objOffersDao.getCurrentOffers();
		} else {
			
			listOfOffers = objOffersDao.getFilteredOffers(listStoreFilters);
		}
